...
const KEYBOARD_LAYOUTS = {
  jis: {
    label: "日本語配列",
    shortLabel: "JIS",
    // sub にはかな（実機 JIS キーボードの見た目）を表示する。
    keys: {
      "`": { main: "半/全", chars: ["`"] },
      "1": { main: "1", sub: "ぬ", chars: ["1", "!"] },
      "2": { main: "2", sub: "ふ", chars: ["2", "\""] },
      "3": { main: "3", sub: "あ", chars: ["3", "#"] },
      "4": { main: "4", sub: "う", chars: ["4", "$"] },
      "5": { main: "5", sub: "え", chars: ["5", "%"] },
      "6": { main: "6", sub: "お", chars: ["6", "&"] },
      "7": { main: "7", sub: "や", chars: ["7", "'"] },
      "8": { main: "8", sub: "ゆ", chars: ["8", "("] },
      "9": { main: "9", sub: "よ", chars: ["9", ")"] },
      "0": { main: "0", sub: "わ", chars: ["0"] },
      "-": { main: "-", sub: "ほ", chars: ["-", "="] },
      "=": { main: "^", sub: "へ", chars: ["^", "~"] },
      "[": { main: "@", sub: "゛", chars: ["@", "`"] },
      "]": { main: "[", sub: "゜", chars: ["[", "{"] },
      ...
      ".": { main: ".", sub: "る", chars: [".", ">"] },
      "/": { main: "/", sub: "め", chars: ["/", "?"] },
      q: { main: "Q", sub: "た", chars: ["q"] },
      w: { main: "W", sub: "て", chars: ["w"] },
      e: { main: "E", sub: "い", chars: ["e"] },
      r: { main: "R", sub: "す", chars: ["r"] },
      t: { main: "T", sub: "か", chars: ["t"] },
      y: { main: "Y", sub: "ん", chars: ["y"] },
      u: { main: "U", sub: "な", chars: ["u"] },
      i: { main: "I", sub: "に", chars: ["i"] },
      o: { main: "O", sub: "ら", chars: ["o"] },
      p: { main: "P", sub: "せ", chars: ["p"] },
      a: { main: "A", sub: "ち", chars: ["a"] },
      s: { main: "S", sub: "と", chars: ["s"] },
      d: { main: "D", sub: "し", chars: ["d"] },
      f: { main: "F", sub: "は", chars: ["f"] },
      g: { main: "G", sub: "き", chars: ["g"] },
      h: { main: "H", sub: "く", chars: ["h"] },
      j: { main: "J", sub: "ま", chars: ["j"] },
      k: { main: "K", sub: "の", chars: ["k"] },
      l: { main: "L", sub: "り", chars: ["l"] },
      z: { main: "Z", sub: "つ", chars: ["z"] },
      x: { main: "X", sub: "さ", chars: ["x"] },
      c: { main: "C", sub: "そ", chars: ["c"] },
      v: { main: "V", sub: "ひ", chars: ["v"] },
      b: { main: "B", sub: "こ", chars: ["b"] },
      n: { main: "N", sub: "み", chars: ["n"] },
      m: { main: "M", sub: "も", chars: ["m"] },
      " ": { main: "Space", chars: [" "] }
    }
  },
  us: {
